...
dataset = Seq2SeqDataset(Path(test_folder).glob("*001.npz"), previous_poses=20, predicted_poses=10)  # TODO: схерали здесь такие параметры вообще? и *001.npz тоже плохую службу сослужит
